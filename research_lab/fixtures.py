...
from .corpus import FACT_COLUMNS, Corpus
    ...
    for scenario, inputs in fixture["scenarios"].items():
        ...
        for metric, value in inputs.items():
            ...
            row = dict(
                ...
                accounting_basis="synthetic_adjusted_diluted_v1",
